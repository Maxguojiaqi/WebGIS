...
//	      	<gml:pos>-64.450018488 45.886673304</gml:pos>
//        	<gml:pos>-61.933352224 47.053339784</gml:pos>
...
function PostGeoServer($minX,$minY,$maxX,$maxY)
{
  ...
  <output>
	...
	{
		$filesave = "../SCRIPT/python/data.tif";
...
{
    $result = exec('python3 ../SCRIPT/python/bandInfo.py');

    if($result){
        return("Save the raster band information to ASCII");
    }else{
...
// FB::info();
echo json_encode(array($postStatus,$pythonStatus));
